...
class School(Base):
    ...
    students = relationship('Student', back_populates='school', foreign_keys="[Student.school_id]")
    staffs = relationship('Staff', back_populates='school', foreign_keys="[Staff.school_id]")
